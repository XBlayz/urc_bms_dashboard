...
- [?] Istantaneous stats from multi-signal (min, max, avg, dev, delta)
  - only selected signals, shown in plate uder plot
- [?] Time window stats for single-signal (min, max, avg, dev)
  - only shown on histogram
